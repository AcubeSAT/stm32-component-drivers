#ifndef SU_SOFTWARE_HAL_PWM_HPP
#define SU_SOFTWARE_HAL_PWM_HPP
...
public:
     ...
     * @param duty The duty cycle value (0 to 65535).
     *
     * This function sets the duty cycle for a specific channel of the specified peripheral.
     */
    template <uint8_t PeripheralNumber>
    static void PWM_ChannelDutySet(PWM_CHANNEL_NUM pwmChannel, uint16_t duty);
};

#endif // SU_SOFTWARE_HAL_PWM_HPP
